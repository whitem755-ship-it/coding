...
"input() function allows user to type data into a program and assign a variable to it"
"String concatenations are where you can combine 2 or more strings together"
"Data casting is when you change one data type to another data type"

# 2. What data type will the following snippet of code output?
print(30/ 232)
"The data type that the snippet will output is a Float"
...
# ==
"Comparsion operartor family"
# >
"Comparison operartor family"
